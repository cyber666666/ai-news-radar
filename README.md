...
- **栏目 tab**：全部/模型/产品/开发者/行业/论文/社区/自媒体，互斥单选，参考 [AIHOT](https://aihot.virxact.com) 的单层分类思路
...
- **AIHOT 子来源分类**：聚合站点条目会按原始平台再细分成 X / 公众号 / HN / RSS 小标签，紧跟在来源 chip 之后
...
| v0.9 | 三个视图并存，怎么看着像一条新闻线？ | 单层信息架构（栏目 tab×精选全量×时间轴）、标题增强、同一事件多源展开、数据同源切换、AIHOT 子来源分类 |
